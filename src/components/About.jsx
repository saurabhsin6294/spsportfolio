...
import stackImage from '../assets/about/saurabh-avatar.png';
import { aboutContent } from '../data/portfolioData';

// Tech stack SVG icons rendered inline for crisp rendering
const LaravelIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <svg className="w-16 h-16 md:w-20 md:h-20" viewBox="0 0 24 24" fill="#FF2D20">
      <path d="M22 6.556l-8.5 4.908v9.814l8.5-4.908V6.556zM12 11.464L3.5 6.556 12 1.648l8.5 4.908-8.5 4.908zm-8.5 4.908v-9.814l8.5 4.908v9.814l-8.5-4.908z"/>
    </svg>
...
const PhpIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <svg className="w-16 h-16 md:w-20 md:h-20" viewBox="0 0 128 128">
      ...
      <text x="64" y="74" fill="#FFFFFF" fontSize="32" fontWeight="black" fontFamily="sans-serif" textAnchor="middle">PHP</text>
    </svg>
    <span className="text-xs font-bold text-white/70 uppercase tracking-wider">PHP</span>
  </div>
);
          ...
          <div data-aos="drop-bounce" className="relative flex justify-center w-full">
            ...
            <div className="bg-gray-900 w-full max-w-[280px] rounded-2xl p-3 shadow-[0_20px_40px_rgba(0,0,0,0.4)] relative z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="w-full aspect-[3/4] overflow-hidden rounded-xl bg-gray-800 border-2 border-transparent">
                <img 
                  src={stackImage} 
                  alt="Saurabh Pratap Singh — Full Stack Web Developer" 
